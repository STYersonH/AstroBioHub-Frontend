...
const PaperAcademicCard = ({ dataPaper, ...props }) => {
  const {
    setShowPaperSummary,
  ...
  return (
    <div
      ...
      className={cn(
        ...
        numberCitationPaperSelected === dataPaper.orderPaperReference
          ? "bg-gray-50"
          : "",
      )}
      onClick={() => {
        setShowPaperSummary(true);
        setNumberCitationPaperSelected(dataPaper.orderPaperReference);
      }}
    >
