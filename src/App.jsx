...
function App() {
  ...
  return (
    <>
      <motion.div
        className="relative flex h-screen w-screen items-center justify-center bg-white"
        animate={{
          background:
      ...
      >
        ...
        <motion.a
          href="https://github.com/STYersonH/AstroBioHub-Frontend/"
          target="_blank"
          rel="noopener noreferrer"
          className="absolute top-4 right-4 z-10 flex items-center gap-2 rounded-lg bg-black/10 px-3 py-2 backdrop-blur-sm transition-all duration-300 hover:bg-black/20"
